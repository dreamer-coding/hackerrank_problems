...
string kangaroo(int32_t x1, int32_t v1, int32_t x2, int32_t v2) {
    try {
        if (x1 < 0 || x2 < 0) {
            throw std::invalid_argument("Negative numbers are not allowed for X values.");
        } else if (v1 < 0 || v2 < 0) {
            throw std::invalid_argument("Negative numbers are not allowed for V values.");
        }
